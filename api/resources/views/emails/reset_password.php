                ...
                <div class="content">
                    <table bgcolor="#999999">
                        <tr>
                            <td></td>
                            <td align="right">
                                <h6 class="collapse">Reset password</h6>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <td class="container" bgcolor="#FFFFFF">
                <div class="content">
                    <table>
                        <tr>
                            <td>
                                <h3>Hi, <?php echo $this->user->name?></h3>
                                <p class="lead">You need to reset your password to access our app.</p>
                                <p>This token will expire within 24h.</p>
                                <p>If you didn't requested to reset your password, just ignore this e-mail.</p>
                                <p class="callout">
                                    Access <code><?php echo env('RESET_PASSWORD_LINK').'?token='.$this->token?></code> or click on the button below to 
                                    reset your password.
                                    <a href="<?php echo env('RESET_PASSWORD_LINK').'?token='.$this->token?>">Reset your password &raquo;</a>
                                </p>
                            </td>
                        </tr>
                    </table>
