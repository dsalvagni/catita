...
class SessionController extends \App\Http\Controllers\Controller
{
    ...
    * @apiName GetSession
    * @apiGroup Session
    * @apiDescription This service returns information about the current user session.
    * It returns pretty basic information and should stays like this.
    *
    ...
    * @apiGroup Session
    * @apiDescription This service should create a new user session 
    * for a login authentication attempt.
    *
    * It will return the basic session's information when the user logged in. 
    *
